...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.showTermsOfService = function () {
    ...
    LoginPage.prototype.changeCheck = function ($event) {
    ...
    LoginPage.prototype.login = function () {
        ...
        var mobileInput = jquery__WEBPACK_IMPORTED_MODULE_3__('#mobileInput').val();
        ...
        if (emailInput === '' || passwordInput === '' || mobileInput === '' || this.checked == false) {
            ...
            this.presentLoading();
            var login = this.requests.Login(url, emailInput, passwordInput, mobileInput);
