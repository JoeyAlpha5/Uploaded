...
var Tab4Page = /** @class */ (function () {
    ...
    Tab4Page.prototype.cropImage = function (image) {
        this.myImage = 'https://res.cloudinary.com/uploaded/image/upload/v1567818053/' + image + '.png';
    };
    //crop options
    Tab4Page.prototype.reset = function () {
        this.angularCropper.cropper.reset();
    };
    Tab4Page.prototype.clear = function () {
        this.angularCropper.cropper.clear();
    };
    Tab4Page.prototype.rotate = function () {
        this.angularCropper.cropper.rotate(90);
    };
    Tab4Page.prototype.zoom = function (zoomIn) {
        var factor = zoomIn ? 0.1 : -0.1;
        this.angularCropper.cropper.zoom(factor);
    };
    Tab4Page.prototype.scaleX = function () {
        this.scaleValX = this.scaleValX * -1;
        this.angularCropper.cropper.scaleX(this.scaleValX);
    };
    Tab4Page.prototype.scaleY = function () {
        this.scaleValY = this.scaleValY * -1;
        this.angularCropper.cropper.scaleY(this.scaleValY);
    };
    Tab4Page.prototype.move = function (x, y) {
        this.angularCropper.cropper.move(x, y);
    };
    Tab4Page.prototype.downloadImage = function (data, filename) {
        var _this = this;
    ...
    Tab4Page.prototype.save = function () {
    ...
    Tab4Page.prototype.changeListener = function ($event) {
        ...
        if (this.file == undefined) {
            ...
            this.storage.get("mail").then(function (user_email) {
                var upload = _this.requests.UploadCoverImage(_this.profile_url, user_email, _this.file);
                _this.presentLoadingWithOptions("Loading, please wait...");
                upload.subscribe(function (x) {
                    //this.cropImage(x);
