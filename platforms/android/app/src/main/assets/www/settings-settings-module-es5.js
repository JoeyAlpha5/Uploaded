...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js"), __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js"), __webpack_require__(/*! cropperjs/dist/cropper */ "./node_modules/cropperjs/dist/cropper.js")) :
	undefined;
...
/* harmony import */ var angular_cropperjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! angular-cropperjs */ "./node_modules/angular-cropperjs/angular-cropperjs.umd.js");
/* harmony import */ var angular_cropperjs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(angular_cropperjs__WEBPACK_IMPORTED_MODULE_5__);
...
var SettingsPageModule = /** @class */ (function () {
    ...
    SettingsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: [
                angular_cropperjs__WEBPACK_IMPORTED_MODULE_5__["AngularCropperjsComponent"],
            ],
            declarations: [_settings_page__WEBPACK_IMPORTED_MODULE_7__["SettingsPage"], angular_cropperjs__WEBPACK_IMPORTED_MODULE_5__["AngularCropperjsComponent"]]
        })
    ], SettingsPageModule);
...
var SettingsPage = /** @class */ (function () {
    ...
    //cropping
    SettingsPage.prototype.cropImage = function (image) {
    ...
    SettingsPage.prototype.rotate = function () {
        this.angularCropper.cropper.rotate(90);
    };
    SettingsPage.prototype.zoom = function (zoomIn) {
        var factor = zoomIn ? 0.1 : -0.1;
        this.angularCropper.cropper.zoom(factor);
    };
    SettingsPage.prototype.scaleX = function () {
        this.scaleValX = this.scaleValX * -1;
        this.angularCropper.cropper.scaleX(this.scaleValX);
    };
    SettingsPage.prototype.scaleY = function () {
        this.scaleValY = this.scaleValY * -1;
        this.angularCropper.cropper.scaleY(this.scaleValY);
    };
    SettingsPage.prototype.move = function (x, y) {
        this.angularCropper.cropper.move(x, y);
    };
    SettingsPage.prototype.downloadImage = function (data, filename) {
        var _this = this;
        ...
        a.download = filename;
        this.storage.get("mail").then(function (user_email) {
            var upload = _this.requests.UploadCroppedCoverImage(_this.profile_url, user_email, data.substring(23));
            upload.subscribe(function (x) {
                _this.cropImage(x);
                _this.ionViewDidEnter();
                console.log(x);
    ...
    SettingsPage.prototype.dataURLtoFile = function (dataurl, filename) {
        var _this = this;
        ...
        this.storage.get("mail").then(function (user_email) {
            var upload = _this.requests.UploadCroppedCoverImage(_this.profile_url, user_email, file);
            upload.subscribe(function (x) {
                _this.cropImage(x);
                _this.ionViewDidEnter();
                console.log(x);
