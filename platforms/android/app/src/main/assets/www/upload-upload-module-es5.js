...
var UploadPage = /** @class */ (function () {
    ...
    UploadPage.prototype.upload = function () {
        ...
        var message = "";
        var selectedMonthDay = this.todayDate;
        var selectedTime = this.Time;
        var post_day = new Date(selectedMonthDay).getDate();
        var post_month = new Date(selectedMonthDay).getMonth();
        var selectedHours = new Date(selectedTime).getHours();
        var selectedMinutes = new Date(selectedTime).getMinutes();
        var publish_date = post_day + "/" + (post_month + 1) + "/" + selectedHours + ":" + selectedMinutes;
        ...
        if (this.file == undefined) {
            ...
            var upload = this.requests.Upload(this.profile_url, user_email, this.file, description, genre, this.addToPlaylist, publish_date, this.tagged_ids);
