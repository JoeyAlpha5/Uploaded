...
var MessagingPage = /** @class */ (function () {
    function MessagingPage(tabs, statusBar, storage, database, route, requests) {
        this.tabs = tabs;
    ...
    MessagingPage.prototype.sendMessage = function () {
        var _this = this;
        var messageInput = jquery__WEBPACK_IMPORTED_MODULE_7__("#message").val();
        ...
        this.storage.get("current_userID").then(function (id) {
            ...
            console.log(chat_id);
            if (messageInput != "") {
                var message = { "sender": _this.this_username, "to": _this.receiverUsername, "message": messageInput };
                //send message notification
                _this.sendMessageNotification(_this.receiverUsername, messageInput, _this.this_username);
                _this.database.list("chats/" + chat_id).push(message);
