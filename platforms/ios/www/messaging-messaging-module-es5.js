...
var MessagingPage = /** @class */ (function () {
    function MessagingPage(location, media, mediaCapture, fstorage, tabs, toastController, statusBar, storage, database, route, requests) {
    ...
    MessagingPage.prototype.back = function () {
        // this.tabs.bottom = true;
        this.location.back();
    };
