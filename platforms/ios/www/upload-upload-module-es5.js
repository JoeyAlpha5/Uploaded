...
var UploadPage = /** @class */ (function () {
    function UploadPage(requests, route, loadingController, storage) {
        this.requests = requests;
        this.route = route;
        this.loadingController = loadingController;
        this.storage = storage;
        this.profile_url = 'http://127.0.0.1:8000/users/users';
    ...
    UploadPage.prototype.upload = function () {
        ...
        if (this.file == undefined) {
            ...
            upload.subscribe(function (x) { return console.log(x); });
        }
    };
    //loading component
    ...
    UploadPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_requests_service__WEBPACK_IMPORTED_MODULE_2__["RequestsService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"], _ionic_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"]])
    ], UploadPage);
    return UploadPage;
}());
