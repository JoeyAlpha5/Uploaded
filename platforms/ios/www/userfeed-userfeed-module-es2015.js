...
let UserfeedPage = class UserfeedPage {
    constructor(navCtrl, location, alertController, keyboard, tabs, platform, loadingController, statusBar, actionSheetController, toastController, requests, database, route, storage, oneSignal) {
