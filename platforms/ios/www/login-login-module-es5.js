...
var LoginPage = /** @class */ (function () {
    function LoginPage(loadingController, statusBar) {
    ...
    LoginPage.prototype.login = function () {
        var emailInput = jquery__WEBPACK_IMPORTED_MODULE_2__('#emailInput').val();
        var passwordInput = jquery__WEBPACK_IMPORTED_MODULE_2__('#passwordInput').val();
